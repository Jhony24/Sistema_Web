...
@Component({
  selector: "app-aprobar-ficticio",
  templateUrl: "./aprobar-ficticio.component.html",
  styleUrls: ["./aprobar-ficticio.component.css"],
})
export class AprobarFicticioComponent implements OnInit {
  ...
  constructor(
    ...
    if (this.id) {
      this.editing = true;
      this.servicio.getListadoPostulantesFicticio().subscribe(
        (data: Postulacion[]) => {
    ...
    Swal.fire({
      ...
      if (result.value) {
        ...
        this.servicio
          ...
          .subscribe((data) => {});
        this.ruta.navigateByUrl("/principal/proyecto_3ero-nuevos");
        Swal.fire(
      ...
      if (result.value) {
        ...
        this.servicio
          ...
          .subscribe((data) => {
            ...
            this.ruta.navigate(["/principal/proyecto_3ero-nuevos"]);
          });
      }
    });
  }
